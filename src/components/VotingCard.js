        ...
        <div className="items-center justify-center hover:bg-white hover:border hover:border-black hover:rounded-lg p-3">
            ...
            <div className="flex justify-between items-center">
                ...
                <button onClick={(e)=>{
                  ...
                  submitVotes(e)
                }} disabled={props.disabled} className="bg-purple-400 text-white hover:bg-white hover:text-purple-400 hover:border hover:border-purple-400 rounded-lg px-4 py-2">VOTE <p>{votes}</p> <p>{ props.numberOfVotes }</p> </button>
