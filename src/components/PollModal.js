...
const PollModal = async ({ showModal, setShowModal, pollCandidate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const newPollCandidate = { pollCandidateName, pollCandidateAge, pollCandidateDepartment }

    const poll = { positionName, newPollCandidate };
