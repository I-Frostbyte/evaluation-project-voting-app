...
const CandidatesModal = ({ showCandidateModal, setShowCandidateModal }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const candidate = { name, department, age, promise, profilePicture}
        ...
        <div className="p-7 z-10 relative" id="hero-first" showCandidateModal={showCandidateModal}>
            <form className='w-9/12' onSubmit={handleSubmit}>                
                ...
                <div className="items-center my-3">
                    <label for="campaign-promise" className='font-bold'>Candidate's Campaign Promise</label><br /><textarea onChange={(e) => setPromise(e.target.value)} value={promise} name="campaign-promise" id="campaign-promise" cols="30" rows="10" placeholder='Tell us your future' maxlength="300" minlength="5" className='ml-48 rounded-xl px-5 py-2'></textarea>
                </div>
